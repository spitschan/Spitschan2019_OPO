...
theFiles = {'Schwerdtfeger1994_ZeissClarletF580.csv'; 'Schwerdtfeger1994_WoehlkHydroFlexRP.csv' ;'Schwerdtfeger1994_RodenstockL660.csv';'Schwerdtfeger1994_CorningCPF550S.csv';'ZeissF580.csv';
    ...
    'Multilens550POL.csv'; 'Multilens527POL.csv'; 'Multilens511POL.csv';'Swiss_Lens_StressFree.csv'; 'Zeiss_BlueProtect.csv';
    'Multilens550.csv';
    'Multilens527.csv'; 'Multilens511.csv';'Multilens450POL.csv';'Multilens450.csv';
    'EssilorOrmaRT85.csv'; 'EssilorOrmaRT50.csv';'Eschenbach550POL.csv';'Eschenbach527POL.csv';
    ...
    'Essilor_Crizal_Prevencia.csv';'Hoya_BlueControl.csv';'BPI_Monochrome_600nm.csv';'Swiss_Lens_Noflex.csv';'BPI_Ski_tint.csv';
    ...
    'Kayumov2005_Offenhaueser_BergerGmbH.csv';'Krueger2017_Eschenbach_wellnessPROTECTwp15.csv';'Lin2016_Jins_ScreenClear.csv';'Lin2016_Jins_ScreenNight.csv';
...
filter_taxonomy2=[];
type_label={'medical lenses'; 'safety lenses'; 'task-specific lenses - sports';'task-specific lenses - driving';'task-specific lenses - VDU use'; 'task-specific lenses - other'};
